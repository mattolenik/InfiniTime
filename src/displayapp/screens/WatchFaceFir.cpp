#include "displayapp/screens/WatchFaceFir.h"
...
WatchFaceFir::WatchFaceFir(Controllers::DateTime& dateTimeController,
  ...
  label_date = lv_label_create(backdrop, nullptr);
  lv_obj_align(label_date, backdrop, LV_ALIGN_CENTER, 0, 60);
  lv_obj_set_style_local_text_color(label_date, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x999999));

  label_time = lv_label_create(backdrop, nullptr);
  lv_obj_set_style_local_text_font(label_time, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &jetbrains_mono_extrabold_compressed);

  lv_obj_align(label_time, backdrop, LV_ALIGN_IN_RIGHT_MID, 0, 0);

  label_time_ampm = lv_label_create(backdrop, nullptr);
  lv_label_set_text_static(label_time_ampm, "");
  lv_obj_align(label_time_ampm, backdrop, LV_ALIGN_IN_RIGHT_MID, -30, -55);

  heartbeatIcon = lv_label_create(backdrop, nullptr);
  lv_label_set_text_static(heartbeatIcon, Symbols::heartBeat);
  lv_obj_set_style_local_text_color(heartbeatIcon, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0xCE1B1B));
  lv_obj_align(heartbeatIcon, backdrop, LV_ALIGN_IN_BOTTOM_LEFT, 0, 0);
  ...
  stepValue = lv_label_create(backdrop, nullptr);
  lv_obj_set_style_local_text_color(stepValue, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x00FFE7));
  lv_label_set_text_static(stepValue, "0");
  lv_obj_align(stepValue, backdrop, LV_ALIGN_IN_BOTTOM_RIGHT, 0, 0);

  stepIcon = lv_label_create(backdrop, nullptr);
  ...
  screen_center = {static_cast<lv_coord_t>(screen_width / 2), static_cast<lv_coord_t>(screen_height / 2)};
  ...
  lv_style_set_bg_grad_stop(&backdrop_style, LV_STATE_DEFAULT, screen_height - 1);
...
WatchFaceFir::~WatchFaceFir() {
  lv_task_del(taskRefresh);
  lv_obj_clean(lv_scr_act());
}

void WatchFaceFir::Refresh() {
  statusIcons.Update();
